...
Conceptually an XOR gate is used to represent an exclusive or logic operation, which means it will only energize when one of the inputs is $1$, but not both. At a surface level it might not seem impossible for a perceptron to be able to predict the outputs of an XOR gate. If the perceptron was able to predict the outputs of an AND gate, what prevents it from predicting the output of an XOR gate? Let's plot a possible decision boundary to see why this is not possible to with a single perceptron.

<Plot htmlPath="/html/partTwo/xor_non_linear.html"/>
<div align="center"><i>Figure 2: XOR Gate With Non-Linear Decision Boundary</i></div>
...
<div align="center"><i>Figure 3: XOR Gate With Linear Decision Boundaries</i></div>
...
<div align="center"><i>Figure 5: XOR Gate Possible Decision Boundaries</i></div>
...
<div align="center"><i>Figure 8: Decision Boundary Training Visualisation</i></div>
...
<div align="center"><i>Figure 9: Derivative Visualisation</i></div>
...
<div align="center"><i>Figure 10: Example 3D Loss Landscape</i></div>
...
<div align="center"><i>Figure 11: Contour Plot Of 3D Loss Landscape With Steepest Ascent Gradient</i></div>
...
<div align="center"><i>Figure 11: Contour Plot Of 3D Loss Landscape With Steepest Descent Gradient</i></div>
...
<div align="center"><i>Figure 13: Transformation Matrix Visualisation</i></div>
...
<div align="center"><i>Figure 14: Transformation Matrix And Bias Translation Visualisation</i></div>
...
<div align="center"><i>Figure 15: Step Function Activation Function</i></div>
...
<div align="center"><i>Figure 17: Sigmoid Derivative</i></div>
...
<div align="center"><i>Figure 18: Neural Network Hidden Layer Transformation</i></div>
...
<div align="center"><i>Figure 19: Neural Network Hidden Layer Transformation On XOR Inputs</i></div>
...
```
<div align="center"><i>Algorithm 1: Neural Network Training Algorithm</i></div>
...
<div align="center"><i>Figure 20: Example Run Of Algorithm - Showing Loss Over Epochs</i></div>
...
<div align="center"><i>Figure 21: Example Run Of Algorithm - Showing Loss Landscape With Sigmoid Activation Function</i></div>
...
<div align="center"><i>Figure 22: Example Run Of Algorithm - Showing Loss Landscape With $Tanh$ Activation Function</i></div>
...
<div align="center"><i>Figure 23: Sigmoid Vs Tanh</i></div>
...
<div align="center"><i>Figure 24: Mish Activation Function</i></div>
...
<div align="center"><i>Figure 25: Sigmoid vs $Tanh$ vs Mish</i></div>
...
<div align="center"><i>Figure 26: Example Run Of Algorithm - Showing Loss Landscape With Mish Activation Function</i></div>
...
<div align="center"><i>Figure 27: Example Run Of Algorithm - Showing Loss Over Epochs</i></div>
...
<div align="center"><i>Figure 28: Two Cocentric Circles Classification Dataset</i></div>
...
<div align="center"><i>Figure 29: Trained Neural Network Hidden Layer Transformation On Cocentric Circles Dataset</i></div>
