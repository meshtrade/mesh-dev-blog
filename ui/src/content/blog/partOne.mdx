...
As said by author John Bradsaw "mistakes are our teachers", the perceptron has no perception of what an AND gate is, so we need to instill this knowledge into the model using trial-and-error algorithm. 
...
<div align="center"><i>Figure 16: Hypothesised XOR Gate Decision Boundary </i></div>
